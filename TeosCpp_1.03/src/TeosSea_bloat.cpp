...
double TeosSea::gsw_pt_from_t(double sa, double t, double p, double p_ref)
{
	...
	s1 = sa/gtc.gsw_ups;
	pt = t
      +(p-p_ref)*( 8.65483913395442e-6
      - s1 *  1.41636299744881e-6  - (p+p_ref) *  7.38286467135737e-9
      + t  *(-8.38241357039698e-6  + s1 *  2.83933368585534e-8
      + t  *  1.77803965218656e-8  + (p+p_ref) *  1.71155619208233e-10));
...
/****************************************************************************************
=======
method: gsw_geo_strf_dyn_height_1(*sa,*ct,*p,p_ref,nz,*dyn_height,max_dp_i,interp_method)
=======
													 ...
													 int nz, double *dyn_height, double max_dp_i, int interp_method)
{
	...
	int i, ipref, *p_indices=NULL, n_i, ni_max, err;
	double dp_min, dp_max, p_min, p_max,*b=NULL, *b_av=NULL,
         *dp=NULL, *sa_i=NULL, *ct_i=NULL, *p_i=NULL, *dh_i=NULL, dh_ref;
	...
	*/
	...
	/**Need to recalculate, so delete here and realloc when needed. */
	if (dp)
	{
	   delete []dp;
	   dp = NULL;
	...
	*/
	...
	p_i = new double[ni_max];
	p_indices = new int[nz];
												 ...
												 double *alpha, double *beta)
{
	...
	v = gsw_gsvco_v(xs, ys, z); /**gsvco.v000
	...
	if (alpha != NULL)
	{
		v_ct = gsw_gsvco_a(xs, ys, z); /**gsvco.a000
         + xs*(gsvco.a100 + xs*(gsvco.a200 + xs*(gsvco.a300
         + xs*(gsvco.a400 + gsvco.a500*xs)))) + ys*(gsvco.a010
         + xs*(gsvco.a110 + xs*(gsvco.a210 + xs*(gsvco.a310
         + gsvco.a410*xs))) + ys*(gsvco.a020 + xs*(gsvco.a120
         + xs*(gsvco.a220 + gsvco.a320*xs)) + ys*(gsvco.a030
         + xs*(gsvco.a130 + gsvco.a230*xs) + ys*(gsvco.a040
         + gsvco.a140*xs + gsvco.a050*ys )))) + z*(gsvco.a001
         + xs*(gsvco.a101 + xs*(gsvco.a201 + xs*(gsvco.a301
         + gsvco.a401*xs))) + ys*(gsvco.a011 + xs*(gsvco.a111
         + xs*(gsvco.a211 + gsvco.a311*xs)) + ys*(gsvco.a021
         + xs*(gsvco.a121 + gsvco.a221*xs) + ys*(gsvco.a031
         + gsvco.a131*xs + gsvco.a041*ys))) + z*(gsvco.a002
         + xs*(gsvco.a102 + xs*(gsvco.a202 + gsvco.a302*xs))
         + ys*(gsvco.a012 + xs*(gsvco.a112 + gsvco.a212*xs)
         + ys*(gsvco.a022 + gsvco.a122*xs + gsvco.a032*ys))
         + z*(gsvco.a003 + gsvco.a103*xs + gsvco.a013*ys
         + gsvco.a004*z)));*/
	...
	if (beta != NULL)
	{
		v_sa_part = gsw_gsvco_b(xs, ys, z); /**gsvco.b000
		...
		double *v_sa, double *v_ct, double *v_p)
{
	...
	if (v_ct != NULL)
	{
		v_ct_part =gsw_gsvco_a(xs, ys, z);  /**gsvco.a000
         + xs*(gsvco.a100 + xs*(gsvco.a200 + xs*(gsvco.a300
         + xs*(gsvco.a400 + gsvco.a500*xs)))) + ys*(gsvco.a010
         + xs*(gsvco.a110 + xs*(gsvco.a210 + xs*(gsvco.a310
         + gsvco.a410*xs))) + ys*(gsvco.a020 + xs*(gsvco.a120
	...
	if (v_p != NULL)
	{
		v_p_part = gsw_gsvco_c(xs, ys, z);  /**gsvco.c000
...
double TeosSea::gsw_ct_from_pt(double sa, double pt)
{
	...
	pot_enthalpy = 61.01362420681071e0
      ...
      + y*(248.39476522971285e0 + (-3.871557904936333e0 - 2.6268019854268356e0*y)*y))
													 ...
													 double *drho_dsa, double *drho_dct, double *drho_dp)
{
	...
	v = gsw_gsvco_v(xs, ys, z); /**gsvco.v000
      + xs*(gsvco.v010 + xs*(gsvco.v020 + xs*(gsvco.v030 + xs*(gsvco.v040
      + xs*(gsvco.v050 + gsvco.v060*xs))))) + ys*(gsvco.v100
      + xs*(gsvco.v110 + xs*(gsvco.v120 + xs*(gsvco.v130
      + xs*(gsvco.v140 + gsvco.v150*xs)))) + ys*(gsvco.v200 + xs*(gsvco.v210
      + xs*(gsvco.v220 + xs*(gsvco.v230 + gsvco.v240*xs))) + ys*(gsvco.v300
      + xs*(gsvco.v310 + xs*(gsvco.v320 + gsvco.v330*xs)) + ys*(gsvco.v400
      + xs*(gsvco.v410 + gsvco.v420*xs) + ys*(gsvco.v500 + gsvco.v510*xs
      + gsvco.v600*ys))))) + z*(gsvco.v001 + xs*(gsvco.v011 + xs*(gsvco.v021
      + xs*(gsvco.v031 + xs*(gsvco.v041 + gsvco.v051*xs)))) + ys*(gsvco.v101
      + xs*(gsvco.v111 + xs*(gsvco.v121 + xs*(gsvco.v131 + gsvco.v141*xs)))
      + ys*(gsvco.v201 + xs*(gsvco.v211 + xs*(gsvco.v221 + gsvco.v231*xs))
      + ys*(gsvco.v301 + xs*(gsvco.v311 + gsvco.v321*xs) + ys*(gsvco.v401
      + gsvco.v411*xs  + gsvco.v501*ys)))) + z*(gsvco.v002 + xs*(gsvco.v012
      + xs*(gsvco.v022 + xs*(gsvco.v032 + gsvco.v042*xs))) + ys*(gsvco.v102
      + xs*(gsvco.v112 + xs*(gsvco.v122 + gsvco.v132*xs)) + ys*(gsvco.v202
      + xs*(gsvco.v212 + gsvco.v222*xs) + ys*(gsvco.v302 + gsvco.v312*xs
      + gsvco.v402*ys))) + z*(gsvco.v003 + xs*(gsvco.v013 + gsvco.v023*xs)
      + ys*(gsvco.v103 + gsvco.v113*xs + gsvco.v203*ys) + z*(gsvco.v004
      + gsvco.v014*xs + gsvco.v104*ys + z*(gsvco.v005 + gsvco.v006*z)))));*/

	rho2 = pow(1.0/v, 2.0);

	if (drho_dsa != NULL)
	{
		v_sa = gsw_gsvco_b(xs, ys, z); /**gsvco.b000
         + xs*(gsvco.b100 + xs*(gsvco.b200 + xs*(gsvco.b300 + xs*(gsvco.b400
         + gsvco.b500*xs)))) + ys*(gsvco.b010 + xs*(gsvco.b110 + xs*(gsvco.b210
         + xs*(gsvco.b310 + gsvco.b410*xs))) + ys*(gsvco.b020 + xs*(gsvco.b120
         + xs*(gsvco.b220 + gsvco.b320*xs)) + ys*(gsvco.b030 + xs*(gsvco.b130
         + gsvco.b230*xs) + ys*(gsvco.b040 + gsvco.b140*xs + gsvco.b050*ys))))
         + z*(gsvco.b001 + xs*(gsvco.b101 + xs*(gsvco.b201 + xs*(gsvco.b301
         + gsvco.b401*xs))) + ys*(gsvco.b011 + xs*(gsvco.b111 + xs*(gsvco.b211
         + gsvco.b311*xs)) + ys*(gsvco.b021 + xs*(gsvco.b121 + gsvco.b221*xs)
         + ys*(gsvco.b031 + gsvco.b131*xs + gsvco.b041*ys))) + z*(gsvco.b002
         + xs*(gsvco.b102 + xs*(gsvco.b202 + gsvco.b302*xs))+ ys*(gsvco.b012
         + xs*(gsvco.b112 + gsvco.b212*xs) + ys*(gsvco.b022 + gsvco.b122*xs
         + gsvco.b032*ys)) + z*(gsvco.b003 + gsvco.b103*xs + gsvco.b013*ys
         + gsvco.b004*z)));*/
	...
	{
		v_ct = gsw_gsvco_a(xs, ys, z); /** gsvco.a000
         + xs*(gsvco.a100 + xs*(gsvco.a200 + xs*(gsvco.a300 + xs*(gsvco.a400
         + gsvco.a500*xs)))) + ys*(gsvco.a010 + xs*(gsvco.a110 + xs*(gsvco.a210
         + xs*(gsvco.a310 + gsvco.a410*xs))) + ys*(gsvco.a020 + xs*(gsvco.a120
         + xs*(gsvco.a220 + gsvco.a320*xs)) + ys*(gsvco.a030 + xs*(gsvco.a130
         + gsvco.a230*xs) + ys*(gsvco.a040 + gsvco.a140*xs + gsvco.a050*ys ))))
         + z*(gsvco.a001 + xs*(gsvco.a101 + xs*(gsvco.a201 + xs*(gsvco.a301
         + gsvco.a401*xs))) + ys*(gsvco.a011 + xs*(gsvco.a111 + xs*(gsvco.a211
         + gsvco.a311*xs)) + ys*(gsvco.a021 + xs*(gsvco.a121 + gsvco.a221*xs)
         + ys*(gsvco.a031 + gsvco.a131*xs + gsvco.a041*ys))) + z*(gsvco.a002
         + xs*(gsvco.a102 + xs*(gsvco.a202 + gsvco.a302*xs)) + ys*(gsvco.a012
         + xs*(gsvco.a112 + gsvco.a212*xs) + ys*(gsvco.a022 + gsvco.a122*xs
         + gsvco.a032*ys)) + z*(gsvco.a003 + gsvco.a103*xs + gsvco.a013*ys
         + gsvco.a004*z)));*/
	...
	if (drho_dp != NULL)
	{
		v_p = gsw_gsvco_c(xs, ys, z); /**gsvco.c000
         + xs*(gsvco.c100 + xs*(gsvco.c200 + xs*(gsvco.c300 + xs*(gsvco.c400
         + gsvco.c500*xs)))) + ys*(gsvco.c010 + xs*(gsvco.c110 + xs*(gsvco.c210
         + xs*(gsvco.c310 + gsvco.c410*xs))) + ys*(gsvco.c020 + xs*(gsvco.c120
         + xs*(gsvco.c220 + gsvco.c320*xs)) + ys*(gsvco.c030 + xs*(gsvco.c130
         + gsvco.c230*xs) + ys*(gsvco.c040 + gsvco.c140*xs + gsvco.c050*ys))))
         + z*(gsvco.c001 + xs*(gsvco.c101 + xs*(gsvco.c201 + xs*(gsvco.c301
         + gsvco.c401*xs))) + ys*(gsvco.c011 + xs*(gsvco.c111 + xs*(gsvco.c211
         + gsvco.c311*xs)) + ys*(gsvco.c021 + xs*(gsvco.c121 + gsvco.c221*xs)
         + ys*(gsvco.c031 + gsvco.c131*xs + gsvco.c041*ys))) + z*(gsvco.c002
         + xs*(gsvco.c102 + gsvco.c202*xs) + ys*(gsvco.c012 + gsvco.c112*xs
         + gsvco.c022*ys) + z*(gsvco.c003 + gsvco.c103*xs + gsvco.c013*ys
         + z*(gsvco.c004 + gsvco.c005*z))));*/
...
double TeosSea::gsw_sound_speed(double sa, double ct, double p)
{
	...
	v = gsw_gsvco_v(xs, ys, z); /**gsvco.v000
      + xs*(gsvco.v010 + xs*(gsvco.v020 + xs*(gsvco.v030 + xs*(gsvco.v040
      + xs*(gsvco.v050 + gsvco.v060*xs))))) + ys*(gsvco.v100 + xs*(gsvco.v110
      + xs*(gsvco.v120 + xs*(gsvco.v130 + xs*(gsvco.v140 + gsvco.v150*xs))))
      + ys*(gsvco.v200 + xs*(gsvco.v210 + xs*(gsvco.v220 + xs*(gsvco.v230
      + gsvco.v240*xs))) + ys*(gsvco.v300 + xs*(gsvco.v310 + xs*(gsvco.v320
      + gsvco.v330*xs)) + ys*(gsvco.v400 + xs*(gsvco.v410 + gsvco.v420*xs)
      + ys*(gsvco.v500 + gsvco.v510*xs + gsvco.v600*ys))))) + z*(gsvco.v001
      + xs*(gsvco.v011 + xs*(gsvco.v021 + xs*(gsvco.v031 + xs*(gsvco.v041
      + gsvco.v051*xs)))) + ys*(gsvco.v101 + xs*(gsvco.v111 + xs*(gsvco.v121
      + xs*(gsvco.v131 + gsvco.v141*xs))) + ys*(gsvco.v201 + xs*(gsvco.v211
      + xs*(gsvco.v221 + gsvco.v231*xs)) + ys*(gsvco.v301 + xs*(gsvco.v311
      + gsvco.v321*xs) + ys*(gsvco.v401 + gsvco.v411*xs + gsvco.v501*ys))))
      + z*(gsvco.v002 + xs*(gsvco.v012 + xs*(gsvco.v022 + xs*(gsvco.v032
      + gsvco.v042*xs))) + ys*(gsvco.v102 + xs*(gsvco.v112 + xs*(gsvco.v122
      + gsvco.v132*xs)) + ys*(gsvco.v202 + xs*(gsvco.v212 + gsvco.v222*xs)
      + ys*(gsvco.v302 + gsvco.v312*xs + gsvco.v402*ys))) + z*(gsvco.v003
      + xs*(gsvco.v013 + gsvco.v023*xs) + ys*(gsvco.v103 + gsvco.v113*xs
      + gsvco.v203*ys) + z*(gsvco.v004 + gsvco.v014*xs + gsvco.v104*ys
      + z*(gsvco.v005 + gsvco.v006*z)))));*/
