...
class TeosBase
{
	public:
		...
		**************************************/
		...
		void   gsw_util_sort_dbl(double *dArray, int nx, int *iArray,
		                           bool ASC=false);/** default value */
      /** default ASC==false means dArray[0] is smallest value, dArray[max] is largest value */
	...
	private: /** data & method/member functions used only by TeosBase */
